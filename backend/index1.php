<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = $userdata->registration($a_name, $a_user, $a_pass);
    ...
    <div class="container">
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="username" name="a_name">
            </div>
            <div class="mb-3">
                <label for="username" class="form-label">User Name</label>
                <input type="text" class="form-control" id="username" name="a_user" onblur="checkusername(this.value)">
                <span id="usernameavailable"></span>
            </div>
            <div class="mb-3">
                <label for="password" class="form-label">Password</label>
                <input type="password" class="form-control" id="password" name="a_pass">
            </div>
